...
class BlogApiPermissionTests(TestCase):
    ...
    def test_comment_detail_api_allows_author_patch(self):
        self.client.force_authenticate(user=self.author)
        response = self.client.patch(
        ...
        self.assertEqual(self.comment.body, "Changed comment")
    ...
    def test_comment_list_api_allows_anonymous_read(self):
